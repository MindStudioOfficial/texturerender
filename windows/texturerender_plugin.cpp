#include "include/texturerender/texturerender_plugin.h"
...
namespace
{
  ...
  public:
    ...
    TexturerenderPlugin(std::unique_ptr<flutter::MethodChannel<flutter::EncodableValue>> channel,
  ...
  {
    auto plugin = std::make_unique<TexturerenderPlugin>(
        std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
            registrar->messenger(), "texturerender",
...
void TexturerenderPluginRegisterWithRegistrar(FlutterDesktopPluginRegistrarRef registrar)
{
  TexturerenderPlugin::RegisterWithRegistrar(
